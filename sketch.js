...
var score=0;
var bg,bg2,ground3Image,ground3
...
function preload(){
  ...
  ground3Image = loadImage("groundGreen.jpg")
...
function setup() {
  ...
  ground3 = createSprite(windowWidth/2,windowHeight/2+680,100000,500)
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if( touches.length > 0 ||keyDown("space") && trex.y >= windowHeight - 41) {
      trex.velocityY = -12;
      touches = []
    }
